...
entry:
  ...
  %result_val8 = alloca i32, align 4
...
ifcont:                                           ; preds = %entry
  ...
  br i1 %eqtmp, label %then3, label %ifcont7

then3:                                            ; preds = %ifcont
  %auto_wrap_result = alloca %result_int32, align 8
  %err_ptr4 = getelementptr inbounds %result_int32, ptr %auto_wrap_result, i32 0, i32 0
  store i8 0, ptr %err_ptr4, align 1
  %val_ptr5 = getelementptr inbounds %result_int32, ptr %auto_wrap_result, i32 0, i32 1
  store i32 1, ptr %val_ptr5, align 4
  %result_val6 = load %result_int32, ptr %auto_wrap_result, align 4
  ret %result_int32 %result_val6

ifcont7:                                          ; preds = %ifcont
  store i64 1, ptr %result_val8, align 4
  store i64 0, ptr %i, align 4
  br label %while_cond

while_cond:                                       ; preds = %while_body, %ifcont7
  %2 = load i32, ptr %i, align 4
  %3 = load i64, ptr %exponent2, align 4
  %4 = sext i32 %2 to i64
  %lttmp9 = icmp slt i64 %4, %3
  br i1 %lttmp9, label %while_body, label %while_exit

while_body:                                       ; preds = %while_cond
  %5 = load i32, ptr %result_val8, align 4
  %6 = load i64, ptr %base1, align 4
  %7 = sext i32 %5 to i64
  %multmp = mul i64 %7, %6
  store i64 %multmp, ptr %result_val8, align 4
...
while_exit:                                       ; preds = %while_cond
  %10 = load i32, ptr %result_val8, align 4
  ...
  store i32 %10, ptr %val_ptr12, align 4
