...
define internal %result_int64 @check_range(i64 %x) {
entry:
...
ifcont:                                           ; preds = %entry
  ...
  %gttmp = icmp sgt i64 %1, 100
  br i1 %gttmp, label %then2, label %ifcont7

then2:                                            ; preds = %ifcont
  %result3 = alloca %result_int64, align 8
  %err_ptr4 = getelementptr inbounds %result_int64, ptr %result3, i32 0, i32 0
  store i8 3, ptr %err_ptr4, align 1
  %val_ptr5 = getelementptr inbounds %result_int64, ptr %result3, i32 0, i32 1
  store i64 0, ptr %val_ptr5, align 4
  %result_val6 = load %result_int64, ptr %result3, align 4
  ret %result_int64 %result_val6
...
ifcont7:                                          ; preds = %ifcont
  ...
  store i64 %2, ptr %val_ptr10, align 4
...
entry:
  ...
  %calltmp2 = call %result_int64 @check_range(i64 50)
  store %result_int64 %calltmp2, ptr %r3, align 4
  %calltmp3 = call %result_int64 @check_range(i64 -5)
  store %result_int64 %calltmp3, ptr %r4, align 4
  ret i64 0
}
