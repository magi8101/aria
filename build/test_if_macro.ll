...
@0 = private unnamed_addr constant [30 x i8] c"\E2\9C\93 IF/ELSE macro test PASSED\00", align 1
@1 = private unnamed_addr constant [30 x i8] c"\E2\9C\97 IF/ELSE macro test FAILED\00", align 1
