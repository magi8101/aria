...
define internal %result_int32 @pow_int32(i32 %base, i32 %exp) {
entry:
  %val = alloca i32, align 4
  %base1 = alloca i32, align 4
  store i32 %base, ptr %base1, align 4
  %exp2 = alloca i32, align 4
  store i32 %exp, ptr %exp2, align 4
  %0 = load i64, ptr %base1, align 4
...
while_body:                                       ; preds = %while_cond
  ...
  %4 = sext i32 %3 to i64
  %subtmp = sub i64 %4, 1
  store i64 %subtmp, ptr %val, align 4
  br label %while_cond
...
entry:
  ...
  %calltmp = call %result_int32 @pow_int32(i32 5, i32 3)
  ...
  store i32 %unwrap_result, ptr %p, align 4
