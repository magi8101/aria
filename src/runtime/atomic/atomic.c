 ...
 * 
 * Provides lock-free atomic operations using C11 atomics.
...
/* ============================================================================
 * Atomic Type Definitions (C11 atomics)
 * ============================================================================ */

struct AriaAtomicBool { _Atomic(bool) value; };
struct AriaAtomicInt8 { _Atomic(int8_t) value; };
struct AriaAtomicUint8 { _Atomic(uint8_t) value; };
struct AriaAtomicInt16 { _Atomic(int16_t) value; };
struct AriaAtomicUint16 { _Atomic(uint16_t) value; };
struct AriaAtomicInt32 { _Atomic(int32_t) value; };
struct AriaAtomicUint32 { _Atomic(uint32_t) value; };
struct AriaAtomicInt64 { _Atomic(int64_t) value; };
struct AriaAtomicUint64 { _Atomic(uint64_t) value; };
struct AriaAtomicPtr { _Atomic(void*) value; };

struct AriaAtomicTBB8 { _Atomic(int8_t) value; };
struct AriaAtomicTBB16 { _Atomic(int16_t) value; };
struct AriaAtomicTBB32 { _Atomic(int32_t) value; };
struct AriaAtomicTBB64 { _Atomic(int64_t) value; };
...
static inline memory_order aria_to_c11_order(AriaMemoryOrder order) {
    switch (order) {
        ...
        case ARIA_MEMORY_ORDER_RELEASE: return memory_order_release;
        case ARIA_MEMORY_ORDER_ACQ_REL: return memory_order_acq_rel;
        case ARIA_MEMORY_ORDER_SEQ_CST: return memory_order_seq_cst;
